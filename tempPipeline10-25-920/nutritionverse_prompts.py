...
{"foods":[{"name":"...","form":"<enum>","mass_g":123,"count":1,"confidence":0.9}]}
...
def get_mass_only_prompt() -> str:
    ...
    Vision model extracts: name, mass_g, form, count (optional), confidence.
...
{"foods":[{"name":"<food>","form":"<enum>","mass_g":<number>,"count":<int?>,"confidence":<0-1>}]}
...
General rules:
• Max 15 items
• Generic names (e.g., "chicken breast", "white rice")
...
2. Fresh salad (lettuce, tomato, cucumber):
...
3. Toasted bagel with cream cheese:
